...
@section('content')
	...
	<div id="content-container">
		<div id="page-head">
			...
			<li><a href="#">{!! trans('backend.users.update_profile') !!}</a></li>
            </ol>
        </div>
		<div id="page-content">
                                            ...
                                            <div class="form-group has-feedback">
                	                            ...
                	                            <div class="col-lg-7">
                	                                <div class="radio">
                	                                    ...
                	                                    <label for="demo-radio-7">{!! trans('backend.users.available') !!}</label>
                	                                    ...
                	                                    <label for="demo-radio-8">{!! trans('backend.users.disable') !!}</label>
                	                                </div>
                	                           </div>
                                            </div>
                                        </div>
